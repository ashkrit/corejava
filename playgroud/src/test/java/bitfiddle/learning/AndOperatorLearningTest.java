...
public class AndOperatorLearningTest {
    ...
    public void operator_single_bit() {
        ...
        int value1 = toInt("1");
        int value2 = toInt("0");
        assertEquals("0", toBinary(value1 & value2));
    }
    ...
    public void operator_multiple_bit() {
        ...
        int value1 = toInt("11");
        int value2 = toInt("10");
        assertEquals("10", toBinary(value1 & value2));
    }
    ...
    public void operator_multiple_bit_more_examples() {
        ...
        assertEquals("100", toBinary(value1 & value2));
    }
